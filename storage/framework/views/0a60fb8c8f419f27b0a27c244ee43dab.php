...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', $siteName); ?><?php echo e($taglineEn ? ' — '.$taglineEn : ($taglineNe ? ' — '.$taglineNe : '')); ?></title>
    <meta name="description" content="<?php echo $__env->yieldContent('description', $siteDesc); ?>">
        ...
        <div class="flex items-center gap-3">
            ...
            <div class="relative" x-data="{ open: false }" @click.outside="open = false">
                ...
                <div x-show="open" x-cloak
                    ...
                    <a href="/profile/<?php echo e(auth()->user()->username); ?>" class="flex items-center gap-2 px-4 py-2.5 text-sm hover:bg-gray-50 dark:hover:bg-gray-700">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-14">
            ...
            <a href="/" class="flex items-center gap-2 flex-shrink-0">
                <span class="text-2xl font-black text-brand-600 tracking-tight"><?php echo e($siteName); ?></span>
                <?php if($taglineNe || $taglineEn): ?>
                <span class="hidden sm:block text-[10px] text-gray-400 font-nepali leading-tight mt-0.5"><?php echo e($taglineNe ?: $taglineEn); ?></span>
                <?php endif; ?>
            </a>
            ...
            <nav class="hidden lg:flex items-center gap-0 overflow-x-auto flex-1 mx-6">
                <?php if($showHome): ?>
                <a href="/" class="whitespace-nowrap px-3 py-4 text-sm font-medium <?php echo e(request()->is('/') ? 'text-brand-600 border-b-2 border-brand-500' : 'text-gray-600 dark:text-gray-300 hover:text-brand-600 border-b-2 border-transparent'); ?> transition-colors">Home</a>
                <?php endif; ?>

                <?php if($useFallback): ?>
                    <?php $__currentLoopData = (\App\Models\Category::orderBy('sort_order')->limit(7)->get() ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="/category/<?php echo e($cat->slug); ?>"
                        class="whitespace-nowrap px-3 py-4 text-sm font-medium font-nepali <?php echo e(request()->is('category/'.$cat->slug) ? 'text-brand-600 border-b-2 border-brand-500' : 'text-gray-600 dark:text-gray-300 hover:text-brand-600 border-b-2 border-transparent'); ?> transition-colors">
                ...
                <?php else: ?>
                    ...
                    <?php $navUrl = $nav->resolvedUrl(); ?>
                    <?php if($nav->children->count()): ?>
                    <div class="relative group">
                        ...
                        <div class="absolute left-0 top-full hidden group-hover:block bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-xl shadow-lg py-2 min-w-[180px] z-50">
                            ...
                            <a href="<?php echo e($child->resolvedUrl()); ?>" target="<?php echo e($child->open_in ?? '_self'); ?>" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 hover:text-brand-600"><?php echo e($child->label); ?></a>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
                    <?php else: ?>
                    <a href="<?php echo e($navUrl); ?>" target="<?php echo e($nav->open_in ?? '_self'); ?>"
                        class="whitespace-nowrap px-3 py-4 text-sm font-medium <?php echo e(request()->is(ltrim($navUrl,'/')) || request()->fullUrlIs(url($navUrl)) ? 'text-brand-600 border-b-2 border-brand-500' : 'text-gray-600 dark:text-gray-300 hover:text-brand-600 border-b-2 border-transparent'); ?> transition-colors">
                        <?php echo e($nav->label); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
        ...
        <div class="flex-1 overflow-hidden relative">
            <div class="ticker-track">
                <?php $__currentLoopData = array_merge($breakingPosts, $breakingPosts); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $title): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <span class="text-sm text-gray-700 dark:text-gray-300 whitespace-nowrap mr-12"><?php echo e($title); ?></span>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
...
<div x-show="formatModal" x-cloak
    ...
    <div class="relative bg-white dark:bg-gray-900 rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto"
        ...
        <div class="p-6 grid grid-cols-3 gap-4">
            <?php $__currentLoopData = $_filteredFormats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$format, $label, $icon, $desc, $url]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e($url); ?>" @click="formatModal = false"
                ...
                <div class="w-14 h-14 rounded-full bg-teal-50 dark:bg-teal-900/30 flex items-center justify-center group-hover:bg-brand-100 dark:group-hover:bg-brand-900/40 transition-colors">
                    <svg class="w-6 h-6 text-teal-600 dark:text-teal-400 group-hover:text-brand-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="<?php echo e($icon); ?>"/>
                    </svg>
                </div>
                <div class="text-center">
                    <p class="text-sm font-semibold text-gray-900 dark:text-white"><?php echo e($label); ?></p>
                    <p class="text-[11px] text-gray-400 mt-0.5 leading-tight"><?php echo e($desc); ?></p>
                </div>
            </a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    ...
    <div class="relative w-72 max-w-[85vw] bg-white dark:bg-gray-900 h-full flex flex-col shadow-2xl overflow-y-auto"
        ...
        <div class="flex items-center justify-between px-5 py-4 border-b border-gray-100 dark:border-gray-800 flex-shrink-0">
            <a href="/" @click="mobileMenu = false" class="text-xl font-black text-brand-600 tracking-tight">
                <?php echo e($siteName); ?><span class="text-brand-400">.</span>
            </a>
        ...
        <div class="px-5 py-4 border-b border-gray-100 dark:border-gray-800">
            <div class="flex items-center gap-3 mb-4">
                ...
                <div class="min-w-0">
                    <p class="font-semibold text-gray-900 dark:text-white text-sm truncate"><?php echo e(auth()->user()->name); ?></p>
            ...
            <div class="grid grid-cols-3 gap-2">
                ...
                <a href="/profile/<?php echo e(auth()->user()->username ?? auth()->user()->name); ?>" @click="mobileMenu = false"
        ...
        <nav class="flex-1 py-3">
            ...
            <a href="/" @click="mobileMenu = false"
                class="flex items-center justify-between px-5 py-3 text-sm font-medium <?php echo e(request()->is('/') ? 'text-brand-600 bg-brand-50 dark:bg-brand-900/20' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800'); ?> transition-colors">
                Home
            </a>
            <?php endif; ?>

            <?php if($useFallback): ?>
                <?php $__currentLoopData = (\App\Models\Category::orderBy('sort_order')->limit(10)->get() ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="/category/<?php echo e($cat->slug); ?>" @click="mobileMenu = false"
                    class="flex items-center justify-between px-5 py-3 text-sm font-medium font-nepali <?php echo e(request()->is('category/'.$cat->slug) ? 'text-brand-600 bg-brand-50 dark:bg-brand-900/20' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800'); ?> transition-colors">
                    <?php echo e($cat->name_ne ?? $cat->name_en); ?>
            ...
            <?php else: ?>
                ...
                <div x-data="{ open: false }">
                    ...
                    <div x-show="open" class="bg-gray-50 dark:bg-gray-800/50">
                        <?php $__currentLoopData = $nav->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e($child->resolvedUrl()); ?>" @click="mobileMenu = false"
                ...
                <?php else: ?>
                <a href="<?php echo e($navUrl); ?>" @click="mobileMenu = false"
                    class="flex items-center justify-between px-5 py-3 text-sm font-medium <?php echo e(request()->is(ltrim($navUrl,'/')) ? 'text-brand-600 bg-brand-50 dark:bg-brand-900/20' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800'); ?> transition-colors">
                    <?php echo e($nav->label); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div class="col-span-1 md:col-span-2">
                <span class="text-2xl font-black text-white"><?php echo e($siteName); ?></span>
                <?php if($siteDesc): ?>
                <p class="mt-2 text-sm font-nepali text-gray-400"><?php echo e($siteDesc); ?></p>
                <?php endif; ?>
            </div>
            <div>
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    <?php $__currentLoopData = (\App\Models\Category::limit(5)->get() ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li><a href="/category/<?php echo e($cat->slug); ?>" class="hover:text-white transition-colors font-nepali"><?php echo e($cat->name_ne ?? $cat->name_en); ?></a></li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul>
            </div>
        </div>
        <div class="mt-8 pt-8 border-t border-gray-800">
            ...
            <div class="mt-6 text-xs text-center text-gray-600">
                © <?php echo e(date('Y')); ?> <?php echo e($siteName); ?>. Built with Laravel <?php echo e(app()->version()); ?> · PHP <?php echo e(PHP_VERSION); ?>
...
<?php /**PATH C:\project\nkhoj\resources\views/layouts/app.blade.php ENDPATH**/ ?>