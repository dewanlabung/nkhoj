...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dashboard'); ?> — <?php echo e($siteName); ?> Admin</title>
...
<div class="flex h-screen overflow-hidden">
    ...
    <aside class="w-60 bg-gray-900 flex-shrink-0 flex flex-col overflow-y-auto">
        ...
        <div class="flex items-center gap-2.5 px-5 py-4 border-b border-white/10 flex-shrink-0">
            <span class="text-xl font-black text-white tracking-tight"><?php echo e($siteName); ?></span>
        ...
        <nav class="flex-1 px-2.5 py-4 space-y-0.5 text-sm">
            ...
            <a href="/admin" class="sl <?php echo e(request()->is('admin') ? 'on' : ''); ?>">
                <svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                Home
            </a>
            <a href="/admin/analytics" class="sl <?php echo e(request()->is('admin/analytics') ? 'on' : ''); ?>">
                <svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
                Analytics
            </a>
            <a href="/admin/themes" class="sl <?php echo e(request()->is('admin/themes*') ? 'on' : ''); ?>">
                <svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01"/></svg>
                Themes
            </a>
            <a href="/admin/navigation" class="sl <?php echo e(request()->is('admin/navigation*') ? 'on' : ''); ?>">
            ...
            <a href="/admin/pages" class="sl <?php echo e(request()->is('admin/pages*') ? 'on' : ''); ?>">
            ...
            <div x-data="{ postsOpen: <?php echo e(request()->is('admin/posts*') ? 'true' : 'false'); ?> }">
                <button @click="postsOpen = !postsOpen"
                    class="sl w-full justify-between <?php echo e(request()->is('admin/posts*') ? 'on' : ''); ?>">
                ...
                <div x-show="postsOpen" x-cloak class="ml-4 mt-0.5 space-y-0.5 border-l border-white/10 pl-3">
                    <a href="/admin/posts" class="sl text-[12.5px] <?php echo e(request()->is('admin/posts') && !request('status') ? 'on' : ''); ?>">
                    ...
                    <a href="/admin/posts?status=draft" class="sl text-[12.5px] <?php echo e(request('status') === 'draft' ? 'on' : ''); ?>">
                        <svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                        Pending Posts
                    </a>
                    <a href="/admin/posts?status=scheduled" class="sl text-[12.5px] <?php echo e(request('status') === 'scheduled' ? 'on' : ''); ?>">
                    ...
                    <a href="/admin/posts?post_format=event" class="sl text-[12.5px] <?php echo e(request('post_format') === 'event' ? 'on' : ''); ?>">
                        <svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                        Events
                    </a>
                    <a href="/admin/posts?status=archived" class="sl text-[12.5px] <?php echo e(request('status') === 'archived' ? 'on' : ''); ?>">
                    ...
                    <a href="/admin/questions" class="sl text-[12.5px] <?php echo e(request()->is('admin/questions*') ? 'on' : ''); ?>">
            ...
            <a href="/admin/categories" class="sl <?php echo e(request()->is('admin/categories*') ? 'on' : ''); ?>">
            ...
            <a href="/admin/tags" class="sl <?php echo e(request()->is('admin/tags*') ? 'on' : ''); ?>">
            ...
            <a href="/admin/polls" class="sl <?php echo e(request()->is('admin/polls*') ? 'on' : ''); ?>">
                <svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
                Polls
            </a>
            <a href="/admin/widgets" class="sl <?php echo e(request()->is('admin/widgets*') ? 'on' : ''); ?>">
            ...
            <a href="/admin/media" class="sl <?php echo e(request()->is('admin/media*') ? 'on' : ''); ?>">
            ...
            <a href="/admin/ads" class="sl <?php echo e(request()->is('admin/ads*') ? 'on' : ''); ?>">
            ...
            <a href="/admin/comments" class="sl <?php echo e(request()->is('admin/comments*') ? 'on' : ''); ?>">
            ...
            <a href="/admin/contacts" class="sl <?php echo e(request()->is('admin/contacts*') ? 'on' : ''); ?>">
            ...
            <a href="/admin/newsletter" class="sl <?php echo e(request()->is('admin/newsletter*') ? 'on' : ''); ?>">
            ...
            <a href="/admin/users" class="sl <?php echo e(request()->is('admin/users*') ? 'on' : ''); ?>">
            ...
            <a href="/admin/roles" class="sl <?php echo e(request()->is('admin/roles*') ? 'on' : ''); ?>">
                <svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg>
                Roles &amp; Permissions
            </a>
            <a href="/admin/badges" class="sl <?php echo e(request()->is('admin/badges*') ? 'on' : ''); ?>">
            ...
            <a href="/admin/content-settings" class="sl <?php echo e(request()->is('admin/content-settings*') ? 'on' : ''); ?>">
            ...
            <a href="/admin/seo" class="sl <?php echo e(request()->is('admin/seo*') ? 'on' : ''); ?>">
                <svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg>
                SEO Tools
            </a>
            <a href="/admin/storage" class="sl <?php echo e(request()->is('admin/storage*') ? 'on' : ''); ?>">
            ...
            <a href="/admin/google-news" class="sl <?php echo e(request()->is('admin/google-news*') ? 'on' : ''); ?>">
            ...
            <a href="/admin/rss-feeds" class="sl <?php echo e(request()->is('admin/rss-feeds*') ? 'on' : ''); ?>">
            ...
            <a href="/admin/email-settings" class="sl <?php echo e(request()->is('admin/email-settings*') ? 'on' : ''); ?>">
                <svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                Email Settings
            </a>
            <a href="/admin/security" class="sl <?php echo e(request()->is('admin/security*') ? 'on' : ''); ?>">
                <svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg>
                Security
            </a>
            <a href="/admin/cache" class="sl <?php echo e(request()->is('admin/cache*') ? 'on' : ''); ?>">
            ...
            <a href="/admin/settings" class="sl <?php echo e(request()->is('admin/settings*') ? 'on' : ''); ?>">
            ...
            <a href="/admin/localized-settings" class="sl <?php echo e(request()->is('admin/localized-settings*') ? 'on' : ''); ?>">
            ...
            <a href="/admin/languages" class="sl <?php echo e(request()->is('admin/languages*') ? 'on' : ''); ?>">
    ...
    <div class="flex-1 flex flex-col min-w-0">
        ...
        <header class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-6 h-14 flex items-center justify-between flex-shrink-0">
            <div>
                <h1 class="text-base font-bold text-gray-900 dark:text-white"><?php echo $__env->yieldContent('title', 'Dashboard'); ?></h1>
            </div>
                ...
                <div class="relative" x-data="{ open: false }" @click.outside="open = false">
                    <button @click="open = !open"
                        ...
                        <div class="text-left hidden sm:block">
                            <p class="text-xs font-semibold text-gray-900 dark:text-white leading-none"><?php echo e(auth()->user()->name); ?></p>
                    ...
                    <div x-show="open" x-cloak x-transition:enter="transition ease-out duration-100"
                        ...
                        <div class="px-4 py-3 border-b border-gray-100 dark:border-gray-700">
                            <p class="text-xs font-bold text-gray-900 dark:text-white"><?php echo e(auth()->user()->name); ?></p>
                            <p class="text-[11px] text-gray-400 truncate"><?php echo e(auth()->user()->email); ?></p>
                        </div>

                        <div class="py-1">
                            <a href="/profile/<?php echo e(auth()->user()->username); ?>" target="_blank"
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-2xl mx-4 overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div class="p-6 overflow-y-auto">
            ...
            <div class="grid grid-cols-3 gap-4">
                <?php $__currentLoopData = $formats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fmt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php $c = $colorMap[$fmt['color']]; ?>
                <a href="<?php echo e($fmt['url']); ?>"
                    ...
                    title="<?php echo e($fmt['desc']); ?>">
                    <div class="w-12 h-12 rounded-xl <?php echo e($c); ?> flex items-center justify-center flex-shrink-0 transition-all">
                        <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="<?php echo e($fmt['icon']); ?>"/></svg>
                    </div>
                    <div>
                        <p class="text-xs font-semibold text-gray-800 dark:text-white leading-tight"><?php echo e($fmt['label']); ?></p>
                        <p class="text-[10px] text-gray-400 mt-0.5 leading-snug"><?php echo e($fmt['desc']); ?></p>
                    </div>
                </a>
...
<?php /**PATH C:\project\nkhoj\resources\views/layouts/admin.blade.php ENDPATH**/ ?>