...
<div class="flex h-screen overflow-hidden">
    ...
    <aside class="w-60 bg-gray-900 flex-shrink-0 flex flex-col overflow-y-auto
        ...
        <nav class="flex-1 px-2.5 py-4 space-y-0.5 text-sm">
            ...
            <a href="/admin/appearance" class="sl {{ request()->is('admin/appearance*') ? 'on' : '' }}">
            ...
            <a href="/admin/reports" class="sl {{ request()->is('admin/reports*') ? 'on' : '' }}">
                <svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 21v-4m0 0V5a2 2 0 012-2h6.5l1 1H21l-3 6 3 6H10.5l-1-1H5a2 2 0 00-2 2zm9-13.5V9"/></svg>
                Content Reports
            </a>
            ...
            {{-- Settings Hub --}}
            <a href="/admin/settings-hub" class="sl {{ request()->is('admin/settings-hub') ? 'on' : '' }}">
                <svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zm10 0a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zm10 0a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"/></svg>
                Settings Overview
            </a>

            {{-- Site & Brand --}}
            <div x-data="{ open: {{ request()->is('admin/settings*') || request()->is('admin/localized-settings*') || request()->is('admin/languages*') ? 'true' : 'false' }} }">
                <button @click="open = !open" class="sl w-full justify-between {{ request()->is('admin/settings*') || request()->is('admin/localized-settings*') || request()->is('admin/languages*') ? 'on' : '' }}">
                    <span class="flex items-center gap-2.5">
                        <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" class="w-4 h-4"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01"/></svg>
                        Site &amp; Brand
                    </span>
                ...
                <div x-show="open" x-cloak class="ml-4 mt-0.5 space-y-0.5 border-l border-white/10 pl-3">
                    <a href="/admin/settings" class="sl text-[12.5px] {{ request()->is('admin/settings') || (request()->is('admin/settings*') && !request()->is('admin/settings-hub')) ? 'on' : '' }}">
                    ...
                    <a href="/admin/localized-settings" class="sl text-[12.5px] {{ request()->is('admin/localized-settings*') ? 'on' : '' }}">
                    ...
                    <a href="/admin/languages" class="sl text-[12.5px] {{ request()->is('admin/languages*') ? 'on' : '' }}">
            ...
            {{-- Content & Features --}}
            <div x-data="{ open: {{ request()->is('admin/content-settings*') || request()->is('admin/ai-content*') ? 'true' : 'false' }} }">
                <button @click="open = !open" class="sl w-full justify-between {{ request()->is('admin/content-settings*') || request()->is('admin/ai-content*') ? 'on' : '' }}">
                    <span class="flex items-center gap-2.5">
                        <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" class="w-4 h-4"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4"/></svg>
                        Content &amp; Features
                    </span>
                    <svg class="w-3.5 h-3.5 transition-transform" :class="open ? 'rotate-90' : ''" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
                </button>
                <div x-show="open" x-cloak class="ml-4 mt-0.5 space-y-0.5 border-l border-white/10 pl-3">
                    <a href="/admin/content-settings" class="sl text-[12.5px] {{ request()->is('admin/content-settings*') ? 'on' : '' }}">
                        <svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                        Content Settings
                    </a>
                    <a href="/admin/ai-content" class="sl text-[12.5px] {{ request()->is('admin/ai-content*') ? 'on' : '' }}">
            ...
            {{-- Authentication --}}
            <a href="/admin/auth-settings" class="sl {{ request()->is('admin/auth-settings*') ? 'on' : '' }}">
            ...
            {{-- Infrastructure --}}
            <div x-data="{ open: {{ request()->is('admin/storage*') || request()->is('admin/cache*') || request()->is('admin/queue-settings*') ? 'true' : 'false' }} }">
                <button @click="open = !open" class="sl w-full justify-between {{ request()->is('admin/storage*') || request()->is('admin/cache*') || request()->is('admin/queue-settings*') ? 'on' : '' }}">
                    <span class="flex items-center gap-2.5">
                        <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" class="w-4 h-4"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 12h14M5 12a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v4a2 2 0 01-2 2M5 12a2 2 0 00-2 2v4a2 2 0 002 2h14a2 2 0 002-2v-4a2 2 0 00-2-2m-2-4h.01M17 16h.01"/></svg>
                        Infrastructure
                    </span>
                    <svg class="w-3.5 h-3.5 transition-transform" :class="open ? 'rotate-90' : ''" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
                </button>
                <div x-show="open" x-cloak class="ml-4 mt-0.5 space-y-0.5 border-l border-white/10 pl-3">
                    <a href="/admin/storage" class="sl text-[12.5px] {{ request()->is('admin/storage*') ? 'on' : '' }}">
                    ...
                    <a href="/admin/cache" class="sl text-[12.5px] {{ request()->is('admin/cache*') ? 'on' : '' }}">
                    ...
                    <a href="/admin/queue-settings" class="sl text-[12.5px] {{ request()->is('admin/queue-settings*') ? 'on' : '' }}">
                        <svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 10h16M4 14h16M4 18h16"/></svg>
                        Queue Settings
                    </a>
                </div>
