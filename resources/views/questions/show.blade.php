            ...
            <div class="flex gap-4 px-6 pb-6">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <div class="flex flex-wrap items-center gap-2 mb-4 text-xs text-gray-500">
                        ...
                        <span>·</span>
                        <a href="/category/{{ $question->category->slug }}?tab=questions"
            ...
            <div x-show="sideTab === 'related'" class="space-y-3">
                ...
                <a href="/questions/{{ $rq->slug }}" class="flex items-start gap-2 group">
                    ...
                    <div>
                        ...
                        <p class="text-[10px] text-gray-400 mt-0.5">{{ $rq->answers_count }} answers</p>
                    </div>
                </a>
                @empty
            ...
            <div class="space-y-2.5">
                ...
                <div class="flex items-center gap-2.5">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-[10px] text-gray-400">{{ $member->questions_count }}q · {{ $member->answers_count }}a</p>
                    </div>
                </div>
                @endforeach
            </div>
