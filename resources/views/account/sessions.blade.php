...
<div class="space-y-5">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm p-6">
        ...
        @if(session('success'))
        <div class="mb-4 px-4 py-3 bg-green-50 dark:bg-green-900/20 text-green-700 dark:text-green-300 rounded-xl text-sm">{{ session('success') }}</div>
        @endif
    ...
    <div class="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700 rounded-2xl p-4 flex items-start gap-3">
        ...
        <div>
            ...
            <p class="text-xs text-amber-700 dark:text-amber-400 mt-0.5">If you don't recognise a session, <a href="/account/security" class="underline font-medium">change your password</a> and revoke any unknown sessions above.</p>
        </div>
    </div>
