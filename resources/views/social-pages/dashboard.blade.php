    ...
    <div class="max-w-2xl mx-auto px-4 py-6">
        ...
        <div x-show="activeTab === 'home'" class="space-y-4">
            ...
            <div class="bg-white rounded-2xl p-4 shadow-sm">
                ...
                <div class="grid grid-cols-2 gap-3">
                    <a href="/pages/{{ $page->slug }}#" @click.prevent="activeTab = 'posts'"
                       onclick="document.querySelector('[x-data]').__x.$data.activeTab = 'posts'; location.href='/pages/{{ $page->slug }}'"
                       class="flex items-center gap-3 p-3 rounded-xl border border-gray-200 hover:bg-gray-50 transition">
                    ...
                    <a href="/pages/map" class="flex items-center gap-3 p-3 rounded-xl border border-gray-200 hover:bg-gray-50 transition">
                        <svg class="w-5 h-5 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7"/></svg>
                        <span class="text-sm font-semibold text-gray-700">Map view</span>
                    </a>
                ...
                <div class="bg-white rounded-2xl p-4 shadow-sm">
                    <div class="flex items-start gap-3">
                        ...
                        <form method="POST" action="/pages/{{ $page->slug }}/posts/{{ $post->id }}">
                            @csrf @method('DELETE')
                            <button type="submit" class="text-gray-300 hover:text-red-500" onclick="return confirm('Delete?')">
        ...
        <div x-show="activeTab === 'tools'" class="space-y-4">
            <div class="bg-white rounded-2xl shadow-sm overflow-hidden">
                <div class="px-4 py-3 border-b border-gray-100"><p class="font-bold text-gray-700 text-sm">Engagement</p></div>
                <div class="divide-y divide-gray-100">
                    <a href="/pages/{{ $page->slug }}" class="flex items-center justify-between px-4 py-4 hover:bg-gray-50 transition">
                        <div class="flex items-center gap-3">
                            ...
                            <div><p class="font-semibold text-gray-900 text-sm">Create Event</p><p class="text-gray-500 text-xs">Post an event to your page</p></div>
                        </div>
                    ...
                    <a href="/pages/map" class="flex items-center justify-between px-4 py-4 hover:bg-gray-50 transition">
                        <div class="flex items-center gap-3">
                            ...
                            <div><p class="font-semibold text-gray-900 text-sm">Map Directory</p><p class="text-gray-500 text-xs">See all pages on the map</p></div>
                        </div>
                        <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
                    </a>
                </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm overflow-hidden">
                <div class="px-4 py-3 border-b border-gray-100"><p class="font-bold text-gray-700 text-sm">Profile & Verification</p></div>
                <div class="divide-y divide-gray-100">
                    <a href="/pages/{{ $page->slug }}/settings" class="flex items-center justify-between px-4 py-4 hover:bg-gray-50 transition">
                        <div class="flex items-center gap-3">
                            ...
                            <div><p class="font-semibold text-gray-900 text-sm">Page Settings</p><p class="text-gray-500 text-xs">Update your page details</p></div>
                        </div>
                        <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
                    </a>
                    ...
                    <div class="px-4 py-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex-1">
                                <p class="font-semibold text-gray-900 text-sm">Verification Badge</p>
                                @if($page->is_verified)
                                    <p class="text-green-600 text-xs font-semibold">✓ This page is verified</p>
                                @elseif($hasPendingVerification)
                                    <p class="text-yellow-600 text-xs">Request pending review</p>
                                @else
